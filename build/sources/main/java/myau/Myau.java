...
import myau.module.modules.Insults;
...
public class Myau {
    ...
    public void init() {
        ...
        Myau.moduleManager.modules.put(Insults.class, new Insults());
        Myau.moduleManager.modules.put(Insults.class, new Insults());
        Myau.moduleManager.modules.put(Insults.class, new Insults());
        Myau.moduleManager.modules.put(Insults.class, new Insults());
        ...
        Myau.moduleManager.modules.put(AntiFireball.class, new AntiFireball());
        Myau.moduleManager.modules.put(AntiObfuscate.class, new AntiObfuscate());
        ...
        Myau.moduleManager.modules.put(AutoAnduril.class, new AutoAnduril());
        ...
        Myau.moduleManager.modules.put(BedTracker.class, new BedTracker());
        ...
        Myau.moduleManager.modules.put(InventoryClicker.class, new InventoryClicker());
        ...
        Myau.moduleManager.modules.put(MCF.class, new MCF());
        ...
        Myau.moduleManager.modules.put(Refill.class, new Refill());
        ...
        Myau.moduleManager.modules.put(SpeedMine.class, new SpeedMine());
        ...
        try (InputStreamReader reader = new InputStreamReader(Objects.requireNonNull(Myau.class.getResourceAsStream("/version.json")), StandardCharsets.UTF_8);){
            JsonObject modInfo = new JsonParser().parse((Reader)reader).getAsJsonObject();
