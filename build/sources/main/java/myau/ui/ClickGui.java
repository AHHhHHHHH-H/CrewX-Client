...
extends GuiScreen {
    ...
    public void func_73863_a(int x, int y, float p) {
        ...
        this.field_146297_k.field_71466_p.func_175063_a("Developed by crowly", 4.0f, (float)(this.field_146295_m - 3 - this.field_146297_k.field_71466_p.field_78288_b), new Color(60, 162, 253).getRGB());
    ...
    private void savePositions() {
        ...
        for (CategoryComponent cat : this.categoryList) {
            ...
            pos.addProperty("x", (Number)cat.getX());
            pos.addProperty("y", (Number)cat.getY());
            pos.addProperty("open", Boolean.valueOf(cat.isOpened()));
            json.add(cat.getName(), (JsonElement)pos);
        }
