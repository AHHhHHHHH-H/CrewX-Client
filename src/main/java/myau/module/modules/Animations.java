            ...
            if (event.isUseItem()) {
                switch (itemAction) {
                    ...
                    case DRINK:
                        if (otherAnimation.getValue() == 0) {
                            ...
                            itemRenderer.invoketransformFirstPersonItem(animationProgression, 0.0F);
                        } else {
                            func_178104_a(mc.thePlayer.getHeldItem(), mc.thePlayer, event.getPartialTicks());
                            itemRenderer.invoketransformFirstPersonItem(animationProgression, swingProgress);
                        }
                ...
                switch (swingMode) {
                    ...
                    case 1: // 1.9+
                        func_178105_d(swingProgress);
                        itemRenderer.invoketransformFirstPersonItem(animationProgression, swingProgress);
                        this.translate(0, -((swing - 1) - (swing == 0 ? 0 : Utils.getTimer().renderPartialTicks)) / 5f, 0);
                        break;
                    case 2: // Smooth
                        itemRenderer.invoketransformFirstPersonItem(animationProgression, swingProgress);
