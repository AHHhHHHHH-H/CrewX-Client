...
extends Module {
    ...
    public final FloatProperty autoBlockMinCPS = new FloatProperty("auto-block-min-aps", Float.valueOf(8.0f), Float.valueOf(1.0f), Float.valueOf(20.0f));
    public final FloatProperty autoBlockMaxCPS = new FloatProperty("auto-block-max-aps", Float.valueOf(10.0f), Float.valueOf(1.0f), Float.valueOf(20.0f));
    ...
    private long getAttackDelay() {
        return this.isBlocking ? (long)(1000.0f / (float)RandomUtil.nextLong(((Float)this.autoBlockMinCPS.getValue()).longValue(), ((Float)this.autoBlockMaxCPS.getValue()).longValue())) : 1000L / RandomUtil.nextLong(((Integer)this.minCPS.getValue()).intValue(), ((Integer)this.maxCPS.getValue()).intValue());
    }
    ...
    private boolean isValidTarget(EntityLivingBase entityLivingBase) {
        ...
        if (entityLivingBase != KillAura.mc.field_71439_g && entityLivingBase != KillAura.mc.field_71439_g.field_70154_o) {
            if (entityLivingBase == mc.func_175606_aa() || entityLivingBase == KillAura.mc.func_175606_aa().field_70154_o) {
                return false;
            }
    ...
    public void onPacket(PacketEvent event) {
        if (this.isEnabled() && !event.isCancelled() && KillAura.mc.field_71439_g != null && KillAura.mc.field_71441_e != null) {
    ...
    public void verifyValue(String value) {
        boolean badCps;
        boolean bl = badCps = (Integer)this.autoBlock.getValue() == 2 || (Integer)this.autoBlock.getValue() == 3 || (Integer)this.autoBlock.getValue() == 4 || (Integer)this.autoBlock.getValue() == 5 || (Integer)this.autoBlock.getValue() == 6 || (Integer)this.autoBlock.getValue() == 7;
        if (!this.autoBlock.getName().equals(value)) {
            if (this.swingRange.getName().equals(value)) {
                ...
                if (((Float)this.autoBlockMinCPS.getValue()).floatValue() > ((Float)this.autoBlockMaxCPS.getValue()).floatValue()) {
                    this.autoBlockMaxCPS.setValue(this.autoBlockMinCPS.getValue());
                }
                if (((Float)this.autoBlockMinCPS.getValue()).floatValue() > 10.0f && badCps) {
                    this.autoBlockMinCPS.setValue(Float.valueOf(10.0f));
                }
            } else if (this.autoBlockMaxCPS.getName().equals(value)) {
                if (((Float)this.autoBlockMinCPS.getValue()).floatValue() > ((Float)this.autoBlockMaxCPS.getValue()).floatValue()) {
                    this.autoBlockMinCPS.setValue(this.autoBlockMaxCPS.getValue());
                }
                if (((Float)this.autoBlockMaxCPS.getValue()).floatValue() > 10.0f && badCps) {
                    this.autoBlockMaxCPS.setValue(Float.valueOf(10.0f));
                }
            } else if (this.maxCPS.getName().equals(value) && (Integer)this.minCPS.getValue() > (Integer)this.maxCPS.getValue()) {
                this.minCPS.setValue(this.maxCPS.getValue());
            }
        } else if (badCps && (((Float)this.autoBlockMinCPS.getValue()).floatValue() > 10.0f || ((Float)this.autoBlockMaxCPS.getValue()).floatValue() > 10.0f)) {
            this.autoBlockMinCPS.setValue(Float.valueOf(8.0f));
            this.autoBlockMaxCPS.setValue(Float.valueOf(10.0f));
        }
    }
